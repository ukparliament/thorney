class CardFactory
  def initialize(small: nil, heading_text: nil, heading_translation_url: nil, heading_url: nil, paragraph_content: nil, description_list_content: nil, figure: nil)
    @small = small
