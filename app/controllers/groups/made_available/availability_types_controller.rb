    ...
    class AvailabilityTypesController < ApplicationController
      ...
      def index
        ...
        if @group.is_a?(Parliament::Grom::Decorator::LayingBody)
          list_components << CardFactory.new(heading_text: 'groups.subsidiary-resources.laid-papers', heading_translation_url: group_made_available_availability_types_laid_papers_path).build_card
        end
