  ...
  module MadeAvailable
    class AvailabilityTypesController < ApplicationController
      ...
      def index
        ...
        heading = ComponentSerializer::Heading1ComponentSerializer.new(heading_content: I18n.t('groups.made_available.availability_types.title'), subheading_content: @group.try(:groupName), subheading_link: group_path)
