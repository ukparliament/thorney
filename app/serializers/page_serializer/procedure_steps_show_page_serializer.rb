module PageSerializer
  class ProcedureStepsShowPageSerializer < PageSerializer::BasePageSerializer
    ...
    def list_components
      [].tap do |components|
        components << CardFactory.new(heading_text: 'procedure-steps.subsidiary-resources.work-packages', heading_url: procedure_step_work_packages_path(@procedure_step.graph_id)).build_card
      end
    end
