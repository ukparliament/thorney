module ComponentSerializer
  class CardComponentSerializer < ComponentSerializer::BaseComponentSerializer
    ...
    #  card_small = ComponentSerializer::SmallCompomentSerializer.new(content: 'example string', link: '/mps')
    ...
    #  ComponentSerializer::CardComponentSerializer.new(name: card_file_name, data: {card_type: pugin_card_type, small: card_small, heading: card_heading, paragraph: card_paragraph, list_description: card_list_description, list_generic: card_list_generic, figure: card_figure, link_button: card_link_button, count: card_count}).to_h
