module ComponentSerializer
  class CardComponentSerializer < ComponentSerializer::BaseComponentSerializer
    ...
    #  ComponentSerializer::CardComponentSerializer.new(name: card_file_name, data: {card_type: pugin_card_type, heading: card_heading, paragraph: card_paragraph, figure: card_figure, link_button: card_link_button, count: card_count}).to_h
