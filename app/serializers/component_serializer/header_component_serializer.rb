module ComponentSerializer
  class HeaderComponentSerializer < ComponentSerializer::BaseComponentSerializer
    ...
    #  a_serializer = ComponentSerializer::StatusComponentSerializer.new(type: 'banner', display_data: [display_data(component: 'status', variant: 'banner')], selector: 'css id).to_h
